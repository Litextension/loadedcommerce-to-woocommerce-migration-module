=== CRELoaded (LoadedCommerce) to WooCommerce Migration ===
Contributors: LitExtension
Donate link: 
Tags: CRELoaded to woocommerce, CRELoaded to woocommerce migration, migrate LoadedCommerce to woocommerce  
...
This plugin allows you to migrate your products, orders, customers, passwords and other data from CRELoaded (LoadedCommerce) to WooCommerce automatically.

== Description ==
This plugin allows you to migrate your products, categories, orders, customers, passwords and other data from CRELoaded to WooCommerce automatically. 
...
 
= ADDITIONAL FEATURES =
* No Downtime: Data is migrated with no downtime for your current CRELoaded store
...
* Migrate Recent Data: You have just finished a full migration, after that CRELoaded is still live and continue getting new data, and you want to get your WooCommerce updated with the new data, this feature to avoid starting over again.
...
* Data Security: Direct data transfer from CRELoaded to WooCommerce, NO third party involved
...
3. Go to the Plugins -> CRELoaded to WooCommerce Migration


== Documentation and Support ==
Please visit [LitExtension FAQ section](http://litextension.com/woocommerce-migration-tool/CRELoaded-to-woocommerce.html) if you have any questions about migration to WooCommerce.
